...
public class tabledriven_premtive  
{ 
	public static void main(String [] args)
	{
		...
		try
		{ 
			FileOutputStream fout=new FileOutputStream("Log_tabledriven_premtive.txt",true);
			System.out.println();
			System.out.println("We are using Table Driven premtive real time scheduling algorithm"); 
			System.out.println();
			...
			s = "\nWe are using Table Driven Premtive real time scheduling algorithm\n";
		    b=s.getBytes();  
		    fout.write(b);
			...
			if(flag == 1)
			{
				...
				JFrame frame = new JFrame("Table Driven Premtive scheduling");
